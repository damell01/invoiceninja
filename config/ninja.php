...
return [
    ...
    'web_url' => env('BRAND_WEBSITE_URL', env('APP_URL', 'http://localhost')),
    'admin_token' => env('NINJA_ADMIN_TOKEN', ''),
    'license_url' => env('BRAND_WEBSITE_URL', env('APP_URL', 'http://localhost')),
    ...
    'ninja_client_portal' => env('NINJA_CLIENT_PORTAL', env('APP_URL', 'http://localhost')),
    'debug_enabled' => env('APP_DEBUG', false),
    'require_https' => env('REQUIRE_HTTPS', true),
    'app_url' => rtrim(env('APP_URL', ''), '/'),
    'app_domain' => env('APP_DOMAIN', 'invoicing.co'),
    'app_version' => env('APP_VERSION', '5.13.4'),
    'app_tag' => env('APP_TAG', '5.13.4'),
    ...
    'hosted_ninja_url' => env('HOSTED_NINJA_URL', env('APP_URL', 'http://localhost')),
    ...
    'terms_of_service_url' => [
        'hosted' => env('TERMS_OF_SERVICE_URL', env('BRAND_TERMS_URL', env('APP_URL', 'http://localhost').'/terms')),
        'selfhost' => env('TERMS_OF_SERVICE_URL', env('BRAND_TERMS_URL', env('APP_URL', 'http://localhost').'/terms')),
    ],
    'privacy_policy_url' => [
        'hosted' => env('PRIVACY_POLICY_URL', env('BRAND_PRIVACY_URL', env('APP_URL', 'http://localhost').'/privacy')),
        'selfhost' => env('PRIVACY_POLICY_URL', env('BRAND_PRIVACY_URL', env('APP_URL', 'http://localhost').'/privacy')),
    ],
    'db' => [
    ...
    'contact' => [
        ...
        'ninja_official_contact' => env('NINJA_OFFICIAL_CONTACT', env('BRAND_SUPPORT_EMAIL', env('MAIL_FROM_ADDRESS', 'support@bellflow.app'))),
    ],
    'cached_tables' => [
    ...
    'pdf_page_numbering_font_style' => env('PDF_PAGE_NUMBER_FONT_STYLE', 'I'),
    'pdf_page_numbering_font_size' => env('PDF_PAGE_NUMBER_FONT_SIZE', 9),
    'pdf_page_numbering_font_color_red' => env('PDF_PAGE_NUMBER_FONT_COLOR_RED', 135),
    'pdf_page_numbering_font_color_green' => env('PDF_PAGE_NUMBER_FONT_COLOR_GREEN', 135),
    'pdf_page_numbering_font_color_blue' => env('PDF_PAGE_NUMBER_FONT_COLOR_BLUE', 135),
