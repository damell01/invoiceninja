...
$lang = array(
    ...
    'email_from' => 'The DBell Creations Team',
    ...
    'app_description' => 'DBell Billing is a white-label invoicing and billing solution from DBell Creations. Create and send invoices from any device with web access while keeping each client\'s own document branding intact.',
    'rows' => 'rows',
    'www' => 'www',
    'logo' => 'Logo',
    'subdomain' => 'Subdomain',
    ...
    'pro_plan_feature3' => 'Custom URLs - "billing.yourbrand.com"',
    'pro_plan_feature4' => 'Remove third-party footer branding',
    ...
    'overdue' => 'Overdue',
    'white_label_text' => 'White-label mode is available for $:price per year and removes default platform branding from the invoice and client portal.',
    ...
    'pro_plan_remove_logo' => ':link to remove the default platform logo by joining the Pro Plan',
    ...
    'pro_plan_year_description' => 'One year enrollment in the Pro Plan.',
    'pro_plan_month_description' => 'One month enrollment in the Pro Plan.',
    'enterprise_plan_product' => 'Enterprise Plan',
    'enterprise_plan_year_description' => 'One year enrollment in the Enterprise Plan.',
    'enterprise_plan_month_description' => 'One month enrollment in the Enterprise Plan.',
    ...
    'export_help' => 'Use JSON if you plan to import the data into another compatible billing app.<br/>The file includes clients, products, invoices, quotes and payments.',
    ...
    'wepay_account_description' => 'Payment gateway for '.config('branding.app_name'),
    ...
    'warning' => 'Warning',
    'self-update' => 'Update',
    'update_invoiceninja_title' => 'Update '.config('branding.app_name'),
    'update_invoiceninja_warning' => 'Before upgrading '.config('branding.app_name').' create a backup of your database and files!',
    'update_invoiceninja_available' => 'A new version of '.config('branding.app_name').' is available.',
    'update_invoiceninja_unavailable' => 'No new version of '.config('branding.app_name').' available.',
    ...
    'white_label_license_error' => 'Failed to validate the license. Please contact '.config('branding.support_email').' for more information.',
    ...
    'local_part_help' => 'Customize the local part of your inbound support email, ie. YOUR_NAME@support.yourdomain.com',
    ...
    'migrate_to_next_version' => 'Migrate to the next version of '.config('branding.app_name'),
    'migrate_intro_text' => 'We\'ve prepared the next version of '.config('branding.app_name').'. Click the button below to start the migration.',
    'start_the_migration' => 'Start the migration',
    'migration' => 'Migration',
    'welcome_to_the_new_version' => 'Welcome to the new version of '.config('branding.app_name'),
    ...
    'migration_went_wrong' => 'Oops, something went wrong! Please make sure you have set up a '.config('branding.app_name').' v5 instance before starting the migration.',
    'cross_migration_message' => 'Cross account migration is not allowed. Please contact support for help.',
    ...
    'copy_link' => 'Copy Link',
    'welcome_to_invoice_ninja' => 'Welcome to DBell Billing',
    'optin' => 'Opt-In',
    'optout' => 'Opt-Out',
    ...
    'application_settings_label' => 'Let\'s store the basic information for your DBell Billing installation.',
    ...
    'migration_api_secret_notice' => 'You can find API_SECRET in the .env file or '.config('branding.app_name').' v5. If the property is missing, leave the field blank.',
    ...
    'migration_already_completed_desc' => 'Looks like you already migrated <b> :company_name </b> to the V5 version of '.config('branding.app_name').'. If you want to start over, you can force migrate to wipe existing data.',
    ...
    'new_login_description' => 'You recently logged in to your DBell Billing account from a new location or device:<br><br><b>IP:</b> :ip<br><b>Time:</b> :time<br><b>Email:</b> :email',
    ...
    'stripe_connect_migration_desc' => config('branding.app_name').' v5 uses Stripe Connect to link your Stripe account to '.config('branding.app_name').'. This provides an additional layer of security for your account. Now that your data has migrated, you will need to authorize Stripe to accept payments in v5.<br><br>To do this, navigate to Settings > Online Payments > Configure Gateways. Click on Stripe Connect and then under Settings click Setup Gateway. This will take you to Stripe to authorize '.config('branding.app_name').' and on your return your account will be successfully linked!',
    ...
    'no_available_methods' => 'We can\'t find any credit cards on your device. <a href="'.config('branding.support_url').'" target="_blank" class="underline">Read more about this.</a>',
    ...
    'white_label_body' => 'Thank you for purchasing a white label license. <br><br> Your license key is: <br><br> :license_key <br><br> You can manage your license with your service provider.',
    ...
    'nordigen_requisition_body' => 'Access to bank account feeds has expired as set in the End User Agreement. <br><br>Please log into DBell Billing and re-authenticate with your banks to continue receiving transactions.',
    ...
    'expense_mailbox_help' => 'The inbound email address which accepts expense documents, ie. expense@yourdomain.com',
    ...
    'peppol_token_description' => 'Token is used as another step to make sure invoices are sent securely. Unlike white-label licenses, token can be rotated at any point without needing platform support.',
    ...
    'einvoice_something_went_wrong' => 'Oops! Something went wrong. Contact us at '.config('branding.support_email').' for more information.',
    ...
    'enable_public_notifications_help' => 'Enable real-time notifications from '.config('branding.app_name').'.',
    'navigate' => 'Navigate',
    ...
    'pro_plan_feature_2' => 'Remove third-party footer branding',
    ...
    'docuninja_grant_access_help' => 'Grant users access to DocuNinja',
    ...
    'feedback_slider_title' => 'How likely are you to recommend DBell Billing to a friend or colleague?',
    ...
    'document_type_description' => 'Select the document type to configure signatures on',
    'new_signatory' => 'New Signatory',
    'signatory' => 'Signatory',
    'invoice_ninja_template_description' => 'Customize the location of signatures on billing documents like invoices and quotes',
    ...
    'choose_template_type' => 'Select the type of template you want to create',
    'template' => 'Template',
    'templates' => 'Templates',
    ...
    'docuninja_quota_available_but_no_users' => 'Add a user to '.config('branding.app_name').' first, then grant them access to DocuNinja here',
    ...
    'close_tab' => 'Close Tab',
    'sign' => 'Sign',
    'add_open_exchange' => 'Add Open Exchange Key',
    'all_entity_types_created' => 'All Entity Types Created',
    'amount_must_be_greater_than_zero' => 'Amount must be greater than zero',
    'autobill_failure' => 'Auto-bill failed',
    'autobill_success' => 'Auto-bill successful',
    'available' => 'Available',
    'blueprint' => 'Blueprint',
    'capabilities' => 'Capabilities',
    'card_holder_help' => 'Card holder name',
    'cards' => 'Cards',
    'charts' => 'Charts',
    'company_logo' => 'Company Logo',
    'create_client_or_user' => 'Create Client or User',
    'create_docuninja_account' => 'Create DocuNinja Account',
    'create_recurring_expense' => 'Create Recurring Expense',
    'create_recurring_invoice' => 'Create Recurring Invoice',
    'create_recurring_quote' => 'Create Recurring Quote',
    'create_subscription' => 'Create Subscription',
    'create_user' => 'Create User',
    'created' => 'Created',
    'creating' => 'Creating',
    'credit_signed_notification' => 'Credit Signed Notification',
    'customize_cards' => 'Customize Cards',
    'datatable' => 'Data Table',
    'date_must_be_after_previous_schedule' => 'Date must be after previous schedule',
    'default_checkbox_label' => 'Default Checkbox',
    'default_multiselect_label' => 'Default Multiselect',
    'default_radio_group_label' => 'Default Radio Group',
    'default_select_label' => 'Default Select',
    'delete_document' => 'Delete Document',
    'delete_docuninja_document' => 'Delete file',
    'delete_docuninja_document_confirmation' => 'Are you sure you want to remove this file from the document?',
    'delete_subscription' => 'Delete Subscription',
    'disable_docuninja' => 'Disable DocuNinja',
    'document_not_found' => 'Document not found',
    'docuninja_access_grant_failed' => '',
    'docuninja_access_granted_successfully' => 'DocuNinja access granted successfully',
    'download_signed_document' => 'Download Signed Document',
    'e_expense_created' => 'E-Expense created',
    'edit_rule' => 'Edit Rule',
    'einvoice_delivery_failure' => 'E-Invoice delivery failed',
    'einvoice_delivery_success' => 'E-Invoice delivery success',
    'einvoice_sent' => 'E-Invoice sent',
    'element' => 'Element',
    'email_invoice_failed' => 'Email failed to sent',
    'empty_checkbox_label' => 'Empty Checkbox',
    'end_of_month' => 'End of Month',
    'error_fetching_pricing' => 'Error fetching pricing',
    'exchange_rate_not_enabled' => 'Exchange rate not enabled',
    'failed_payment' => 'Payment failed',
    'field_is_required' => 'Field is required',
    'generate' => 'Generate',
    'google_drive' => 'Google Drive',
    'initials' => 'Initials',
    'initials_description' => 'Initials description',
    'invalid_state' => 'Invalid state',
    'invoice_signed_notification' => 'Invoice signed notification',
    'link_copied' => 'Link copied',
    'make_template_description' => 'Create your own template using your own PDF document to upload',
    'manage' => 'Manage',
    'multiselect_needs_two_options' => 'Multiselect needs two options',
    ...
    'please_select_signer' => 'Please select a signer',
    'proformal_invoices' => 'Proforma invoices',
    'purchase_order_signed_notification' => 'Purchase order signed notification',
    'queue' => 'Queue',
    'quote_field' => 'Quote field',
    'quote_signed_notification' => 'Quote signed notification',
    'radio_needs_two_options' => 'Radio needs two options',
    'recipient' => 'Recipient',
    'redirect' => 'Redirect',
    ...
    'select_needs_two_options' => 'Select needs two options',
    'sending' => 'Sending',
    'setting_up' => 'Setting up',
    'setup_company' => 'Setup company',
    'signature-placeholder' => 'Signature placeholder',
    'signature:font-updated' => 'Signature font updated',
    'signature_description' => 'Signature description',
    'snappdf_not_enabled' => 'Snappdf not enabled',
    'start_signing' => 'Start signing',
    'successfully_signed_document' => 'Successfully signed document',
    'swap_signatory' => 'Swap signatory',
    ...
    'update_recurring_expense' => 'Update recurring expense',
    'update_recurring_invoice' => 'Update recurring invoice',
    'update_recurring_quote' => 'Update recurring quote',
    'update_subscription' => 'Update subscription',
    'update_user' => 'Update User',
    'upgrade_account_message' => 'Upgrade account message',
    'upgrade_now' => 'Upgrade now',
    'upgrade_plan_docuninja' => 'Upgrade your plan to enable DocuNinja',
    'use_signature' => 'Use signature',
    'use_snappdf' => 'Use snappdf',
    'user_note' => 'User note',
    'vendor_notification_email' => 'Vendor notification email',
    'void_document_description' => 'Void document description',
    ...
    'quickbooks_connect_description' => 'Connect your QuickBooks account to DBell Billing to automatically sync your transactions and invoices.',
    'sync_direction_description' => 'These settings determine how DBell Billing will sync with QuickBooks.',
    'sync_direction_none_help' => 'DBell Billing will not sync any data to or from QuickBooks.',
    'sync_direction_pull_help' => 'DBell Billing will pull data from QuickBooks.',
    'sync_direction_push_help' => 'DBell Billing will push data to QuickBooks.',
    'sync_direction_bidirectional_help' => 'DBell Billing will both pull and push data with QuickBooks.',
    'sync_settings' => 'Sync Settings',
    'realm_id' => 'QB Realm ID',
    'default_income_account' => 'Default Income Account',
    'automatic_taxes' => 'Automatic Taxes',
    'automatic_taxes_help' => 'When Automatic Taxes (AST) are enabled in QuickBooks, DBell Billing will first create the invoice in QuickBooks, and then pull the fully formed invoice back into DBell Billing.',
    'pull' => 'Pull',
    'push' => 'Push',
