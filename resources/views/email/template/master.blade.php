                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                            <tr>
                                                                <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                    ...
                                                                    <img align="center" border="0" src="{{ asset($design == 'dark' ? config('branding.logo_dark') : config('branding.logo_light')) }}" alt="{{ config('branding.app_name') }} logo" title="{{ config('branding.app_name') }}" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 34%;max-width: 163.2px;" width="163.2"/>
